...
if __name__ == '__main__':
    ...
    meta_graphs, meta_features, meta_y = read_meta_datasets(args.window)
    ...
    print("Number of node in the graph ",n_nodes)
    if not os.path.exists('../results'):
        os.makedirs('../results')
    fw = open("../results/results_SC.csv","a")
